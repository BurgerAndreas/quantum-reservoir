...
if __name__ == '__main__':
    ...
    calc_column(model_type, col='qctypes', values=['ising', 'ising_nn', 'empty'], data_params=data_of_interest, model_params=model_of_interest, rseeds_data=rseeds_of_interest)
    ...
    # which increasing ftype (feature type = expectation values) and nqubits
